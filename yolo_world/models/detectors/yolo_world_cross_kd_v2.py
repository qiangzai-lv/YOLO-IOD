...
class YOLOWorldCrossKdV2Detector(YOLODetector):
...
@MODELS.register_module()
class YOLOWorldCrossKdUnDetector(YOLODetector):
    """Implementation of YOLOW Series"""
    ...
    def __init__(self,
        ...
        self.class_names = kd_cfg.get('class_names', ())
        self.ori_num_classes = kd_cfg.get('ori_num_classes', 5)
        self.known_num_classes = kd_cfg.get('known_num_classes', 80)
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        # new model forward kd
        texts_new = list(self.class_names[self.ori_num_classes:self.known_num_classes])
