...
model = dict(
    ...
    bbox_head=dict(type='YOLOWorldUnHead',
                   known_cls_num=num_known_cls,
                   head_module=dict(type='YOLOWorldUnHeadModule',
                                    use_bn_head=True,
                                    known_cls_num=num_known_cls,
...
# dataset settings
text_transform = [
    dict(type='RandomLoadTextUnknown',
...
coco_val_dataset = dict(
    ...
    dataset=dict(
        type='YOLOv5CocoDataset',
        data_root='data/coco',
        ann_file='annotations/40+40(order)/instances_val2017_part0.json',
...
val_evaluator = dict(
    ...
    metric_items=['mAP', 'mAP_50', 'mAP_75', 'mAP_s', 'mAP_m', 'mAP_l', 'AR@100', 'AR@300', 'AR@1000', 'AR_s@1000',
                  'AR_m@1000', 'AR_l@1000'],
    ann_file='data/coco/annotations/40+40(order)/instances_val2017_part0.json',
    metric='bbox')
