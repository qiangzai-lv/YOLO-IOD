...
coco_train_dataset = dict(
    ...
    class_text_path='data/coco/annotations/40+40(order)/coco_class_texts_curs1.json',
...
train_cfg = dict(
    ...
    gps_ratio=0.8,
    up_ratio=0.8,
    importance_save_path='data/coco/annotations/40+40(order)/t1_importance_iks.pt',
    max_epochs=max_epochs,
    val_interval=1,
