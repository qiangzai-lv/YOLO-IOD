...
# model settings
model = dict(
    type='YOLOWorldCrossKdV2Detector',
    load_from_weight=load_from,
    ori_setting=dict(
        config='work_dirs/yolo_world_v2_x_finetune_coco_40_40_t0_un_sep/yolo_world_v2_x_finetune_coco_40_40_t0_un_sep.py',
        ckpt='work_dirs/yolo_world_v2_x_finetune_coco_40_40_t0_un_sep/epoch_20.pth',
    ),
    cur_setting=dict(
        config='work_dirs/yolo_world_v2_x_finetune_coco_40_40_t1_gps/yolo_world_v2_x_finetune_coco_40_40_t1_gps.py',
        ckpt='work_dirs/yolo_world_v2_x_finetune_coco_40_40_t1_gps/epoch_20.pth',
    ),
    kd_cfg=dict(
